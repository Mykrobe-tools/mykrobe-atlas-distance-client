...
class LeafDeleteApi(object):
    ...
    def samples_id_nearest_leaf_node_delete(self, id, **kwargs):  # noqa: E501
        """samples_id_nearest_leaf_node_delete  # noqa: E501

        Delete the nearest leaf node associated with a sample based on a sample ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.samples_id_nearest_leaf_node_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.samples_id_nearest_leaf_node_delete_with_http_info(id, **kwargs)  # noqa: E501

    def samples_id_nearest_leaf_node_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """samples_id_nearest_leaf_node_delete  # noqa: E501

        Delete the nearest leaf node associated with a sample based on a sample ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.samples_id_nearest_leaf_node_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method samples_id_nearest_leaf_node_delete" % key
                )
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `samples_id_nearest_leaf_node_delete`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/samples/{id}/nearest-leaf-node', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
