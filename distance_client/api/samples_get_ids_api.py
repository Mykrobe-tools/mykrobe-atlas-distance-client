...
class SamplesGetIdsApi(object):
    ...
    def samples_get(self, **kwargs):  # noqa: E501
        ...
        :param list[str] ids: A comma-separated list of sample IDs
    ...
    def samples_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ids' in local_var_params and  # noqa: E501
                                                        len(local_var_params['ids']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `ids` when calling `samples_get`, number of items must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
